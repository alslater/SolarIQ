...
def settings_tab() -> rx.Component:
    return rx.vstack(
        rx.accordion.root(
            # ── Account ──────────────────────────────────────────────────────
            rx.accordion.item(
                header=rx.text("Account", style=_HEADING),
                content=rx.box(
                    rx.hstack(
                    ...
                    rx.vstack(
                        ...
                        rx.cond(
                            ...
                            rx.text(AppState.current_password_error, style={"font_size": "12px", "color": t.FAIL}),
                            rx.fragment(),
                        ),
                        rx.input(
                        ...
                        rx.cond(
                            ...
                            rx.text(AppState.new_password_error, style={"font_size": "12px", "color": t.FAIL}),
                            rx.fragment(),
                        ),
                        rx.input(
                        ...
                        rx.cond(
                            ...
                            rx.text(AppState.new_password_confirm_error, style={"font_size": "12px", "color": t.FAIL}),
                            rx.fragment(),
                        ),
                        spacing="2",
                        width="100%",
                    ...
                    rx.cond(
                        ...
                        rx.text(AppState.account_form_error, style={"font_size": "13px", "color": t.FAIL, "margin_top": "12px"}),
                        rx.fragment(),
                    ),
                    padding="24px",
                    width="100%",
                    ...
                    content=rx.box(
                        ...
                        rx.vstack(
                            ...
                            rx.cond(
                                ...
                                rx.text(AppState.new_user_username_error, style={"font_size": "12px", "color": t.FAIL}),
                                rx.fragment(),
                            ),
                            rx.input(
                            ...
                            rx.cond(
                                ...
                                rx.text(AppState.new_user_password_error, style={"font_size": "12px", "color": t.FAIL}),
                                rx.fragment(),
                            ),
                            rx.input(
                            ...
                            rx.cond(
                                ...
                                rx.text(AppState.new_user_password_confirm_error, style={"font_size": "12px", "color": t.FAIL}),
                                rx.fragment(),
                            ),
                            rx.hstack(
                                rx.switch(
                                ...
                                rx.text("Create as administrator", style={"font_size": "13px", "color": t.FG}),
                                spacing="2",
                                align="center",
                            ),
                            rx.button(
                        ...
                        rx.cond(
                            ...
                            rx.text(AppState.admin_form_error, style={"font_size": "13px", "color": t.FAIL, "margin_bottom": "12px"}),
                            rx.fragment(),
                        ),
                        rx.table.root(
                            rx.table.header(
                                    ...
                                    lambda user: rx.table.row(
                                        ...
                                        rx.table.cell(
                                            rx.cond(
                                                ...
                                                rx.text("Current user", style={"font_size": "12px", "color": t.MUTED}),
                                                rx.hstack(
                                                    rx.cond(
                                                        user["is_admin"],
                                                        rx.button(
                                                            "Demote",
                                                            on_click=AppState.set_managed_user_admin_role(user["username"], False),
                                                            style={
                                                                "background": "transparent",
                                                                "color": t.PRIMARY,
                                                                "border": f"1px solid {t.ACCENT}",
                                                        ...
                                                        rx.button(
                                                            "Promote",
                                                            on_click=AppState.set_managed_user_admin_role(user["username"], True),
                                                            style={
                                                                "background": "transparent",
                                                                "color": t.PRIMARY,
                                                                "border": f"1px solid {t.ACCENT}",
